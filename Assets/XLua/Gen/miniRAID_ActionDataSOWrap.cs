...
namespace XLua.CSObjectWrap
{
    ...
    public class miniRAIDActionDataSOWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "onPerform", _g_get_onPerform);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "onPerform", _s_set_onPerform);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_onPerform(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                miniRAID.ActionDataSO gen_to_be_invoked = (miniRAID.ActionDataSO)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.onPerform);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_power(RealStatePtr L)
        {
		    try {
                ...
                miniRAID.ActionDataSO gen_to_be_invoked = (miniRAID.ActionDataSO)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.power = (miniRAID.LuaGetter<miniRAID.MobData, float>)translator.GetObject(L, 2, typeof(miniRAID.LuaGetter<miniRAID.MobData, float>));
        ...
        static int _s_set_auxPower(RealStatePtr L)
        {
		    try {
                ...
                miniRAID.ActionDataSO gen_to_be_invoked = (miniRAID.ActionDataSO)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.auxPower = (miniRAID.LuaGetter<miniRAID.MobData, float>)translator.GetObject(L, 2, typeof(miniRAID.LuaGetter<miniRAID.MobData, float>));
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_onPerform(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                miniRAID.ActionDataSO gen_to_be_invoked = (miniRAID.ActionDataSO)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.onPerform = (miniRAID.LuaFunc<System.ValueTuple<miniRAID.GeneralCombatData, miniRAID.MobRenderer, miniRAID.Spells.SpellTarget>, System.Collections.IEnumerator>)translator.GetObject(L, 2, typeof(miniRAID.LuaFunc<System.ValueTuple<miniRAID.GeneralCombatData, miniRAID.MobRenderer, miniRAID.Spells.SpellTarget>, System.Collections.IEnumerator>));
