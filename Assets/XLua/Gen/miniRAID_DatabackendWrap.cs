...
namespace XLua.CSObjectWrap
{
    ...
    public class miniRAIDDatabackendWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetMoveableGrids", _m_GetMoveableGrids);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "mapWidth", _g_get_mapWidth);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "dirc_dxy", _g_get_dirc_dxy);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "dirc_dx", _g_get_dirc_dx);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "dirc_dy", _g_get_dirc_dy);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "possibleDirections", _g_get_possibleDirections);
            
			Utils.RegisterFunc(L, Utils.SETTER_IDX, "mapWidth", _s_set_mapWidth);
		    ...
		    try {
                ...
                
                {
                    ...
                    int _y = LuaAPI.xlua_tointeger(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.getMap( _x, _y );
                        translator.Push(L, gen_ret);
        ...
        static int _m_SetMob(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<miniRAID.GridShape>(L, 4)&& translator.Assignable<miniRAID.MobData>(L, 5)) 
                {
                    int _x = LuaAPI.xlua_tointeger(L, 2);
                    int _y = LuaAPI.xlua_tointeger(L, 3);
                    miniRAID.GridShape _body = (miniRAID.GridShape)translator.GetObject(L, 4, typeof(miniRAID.GridShape));
                    miniRAID.MobData _mob = (miniRAID.MobData)translator.GetObject(L, 5, typeof(miniRAID.MobData));
                    
                    gen_to_be_invoked.SetMob( _x, _y, _body, _mob );
                    
                    
                    
                    return 0;
                }
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector2Int>(L, 2)&& translator.Assignable<miniRAID.GridShape>(L, 3)&& translator.Assignable<miniRAID.MobData>(L, 4)) 
                {
        ...
        static int _m_ClearMob(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 6&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<miniRAID.GridShape>(L, 4)&& translator.Assignable<miniRAID.MobData>(L, 5)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 6)) 
                {
                    int _x = LuaAPI.xlua_tointeger(L, 2);
                    int _y = LuaAPI.xlua_tointeger(L, 3);
                    miniRAID.GridShape _body = (miniRAID.GridShape)translator.GetObject(L, 4, typeof(miniRAID.GridShape));
                    miniRAID.MobData _mob = (miniRAID.MobData)translator.GetObject(L, 5, typeof(miniRAID.MobData));
                    bool _remove = LuaAPI.lua_toboolean(L, 6);
                    
                    gen_to_be_invoked.ClearMob( _x, _y, _body, _mob, _remove );
                ...
                if(gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<miniRAID.GridShape>(L, 4)&& translator.Assignable<miniRAID.MobData>(L, 5)) 
                {
                    ...
                    gen_to_be_invoked.ClearMob( _x, _y, _body, _mob );
                    
                    
                    
                    return 0;
                }
                if(gen_param_count == 5&& translator.Assignable<UnityEngine.Vector2Int>(L, 2)&& translator.Assignable<miniRAID.GridShape>(L, 3)&& translator.Assignable<miniRAID.MobData>(L, 4)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 5)) 
                {
                    UnityEngine.Vector2Int _pos;translator.Get(L, 2, out _pos);
                    miniRAID.GridShape _body = (miniRAID.GridShape)translator.GetObject(L, 3, typeof(miniRAID.GridShape));
                    miniRAID.MobData _mob = (miniRAID.MobData)translator.GetObject(L, 4, typeof(miniRAID.MobData));
        ...
        static int _m_AddFxAt(RealStatePtr L)
        {
		    try {
                ...
                {
                    miniRAID.Buff.GridEffect _fx = (miniRAID.Buff.GridEffect)translator.GetObject(L, 2, typeof(miniRAID.Buff.GridEffect));
                    UnityEngine.Vector2Int _pos;translator.Get(L, 3, out _pos);
        ...
        static int _m_MoveMob(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector2Int _from;translator.Get(L, 2, out _from);
                    UnityEngine.Vector2Int _to;translator.Get(L, 3, out _to);
                    miniRAID.MobData _mob = (miniRAID.MobData)translator.GetObject(L, 4, typeof(miniRAID.MobData));
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetMoveableGrids(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    miniRAID.MobData _mob = (miniRAID.MobData)translator.GetObject(L, 2, typeof(miniRAID.MobData));
                        ...
                        var gen_ret = gen_to_be_invoked.GetMoveableGrids( _mob );
                        translator.Push(L, gen_ret);
        ...
        static int _m_FindPathTo(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 5&& translator.Assignable<UnityEngine.Vector2Int>(L, 2)&& translator.Assignable<UnityEngine.Vector2Int>(L, 3)&& translator.Assignable<miniRAID.MobData.MovementType>(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    UnityEngine.Vector2Int _from;translator.Get(L, 2, out _from);
                    UnityEngine.Vector2Int _to;translator.Get(L, 3, out _to);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector2Int>(L, 2)&& translator.Assignable<UnityEngine.Vector2Int>(L, 3)&& translator.Assignable<miniRAID.MobData.MovementType>(L, 4)) 
                {
                    UnityEngine.Vector2Int _from;translator.Get(L, 2, out _from);
                    UnityEngine.Vector2Int _to;translator.Get(L, 3, out _to);
                    miniRAID.MobData.MovementType _movementType;translator.Get(L, 4, out _movementType);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector2Int>(L, 2)&& translator.Assignable<UnityEngine.Vector2Int>(L, 3)) 
                {
                    UnityEngine.Vector2Int _from;translator.Get(L, 2, out _from);
                    UnityEngine.Vector2Int _to;translator.Get(L, 3, out _to);
        ...
        static int _m_CanGridPlaceMob(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector2Int _center;translator.Get(L, 2, out _center);
                    miniRAID.GridShape _body = (miniRAID.GridShape)translator.GetObject(L, 3, typeof(miniRAID.GridShape));
        ...
        static int _m_FindNearestEmptyGrid(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector2Int>(L, 2)&& translator.Assignable<miniRAID.GridShape>(L, 3)) 
                {
                    UnityEngine.Vector2Int _center;translator.Get(L, 2, out _center);
                    miniRAID.GridShape _body = (miniRAID.GridShape)translator.GetObject(L, 3, typeof(miniRAID.GridShape));
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_mapWidth(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                miniRAID.Databackend gen_to_be_invoked = (miniRAID.Databackend)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushinteger(L, gen_to_be_invoked.mapWidth);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_dirc_dxy(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                miniRAID.Databackend gen_to_be_invoked = (miniRAID.Databackend)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.dirc_dxy);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_dirc_dx(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                miniRAID.Databackend gen_to_be_invoked = (miniRAID.Databackend)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.dirc_dx);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_dirc_dy(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                miniRAID.Databackend gen_to_be_invoked = (miniRAID.Databackend)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.dirc_dy);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_mapWidth(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                miniRAID.Databackend gen_to_be_invoked = (miniRAID.Databackend)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.mapWidth = LuaAPI.xlua_tointeger(L, 2);
